  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <Box sx={{ flex: 1, width: { xs: "100%", md: "50%" } }}>
            ...
            <Typography variant="body1" color="white">
              ...
              کارت پول در نقاط مختلف شهر مخفی شده‌اند و شما می‌تونید با پیدا
              کردنشون، از آتریپا خرید کنید.
            </Typography>
        ...
        <Typography variant="body1" color="white">
          - کارت رو پیدا کنید و کد مخصوصش رو در سایت یا اپلیکیشن آتریپا ثبت
          کنید.
        </Typography>
        <Typography variant="body1" color="white">
          - معادل مبلغ کارت،اعتبار هدیه دریافت کنید و از سفر، اقامت یا هر خریدی
          که دوست دارید،لذت ببرید!
        </Typography>
